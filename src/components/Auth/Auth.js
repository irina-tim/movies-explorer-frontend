    ...
    <section className="auth">
        <form className="auth__container">
            <div className="auth__info">
                ...
                <button 
                    className={`auth__button-auth ${!props.isRegister && "auth__button-login"}`} 
                    type="submit">{props.authButtonText}</button>
                <div className="auth__sign-out-group">
                    <p className="auth__paragraph">{props.paragraphText}</p>
                    <button className="auth__button-small" onClick={handleClick}>{props.smallButtonText}</button>
                </div>
            </form>       
    </section>
  )
